...
public class thotrang extends Boss {
   ...
   @Override
    public void reward(Player plKill) {
        ...
        itemMap.options.add(new Item.ItemOption(50,Util.nextInt(1,5)));
        itemMap.options.add(new Item.ItemOption(77,Util.nextInt(1,5)));
        itemMap.options.add(new Item.ItemOption(103,Util.nextInt(1,5)));
