...
public class sexy extends Boss {

    public sexy() throws Exception {
        super(BossID.sexy, BossesData.sexy);
    }
   @Override
    public void reward(Player plKill) {
        ...
        itemMap = Util.ratiItem(zone,1954, 1, this.location.x, this.location.y, plKill.id);
