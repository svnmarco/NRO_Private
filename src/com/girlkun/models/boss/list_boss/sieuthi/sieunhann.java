...
public class sieunhann extends Boss {

    public sieunhann() throws Exception {
        super(BossID.sieunhann, BossesData.sieunhann);
    }
   @Override
    public void reward(Player plKill) {
        ...
        itemMap = Util.ratiItem(zone,1952, 1, this.location.x, this.location.y, plKill.id);
