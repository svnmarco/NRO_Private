...
public class sexyyy extends Boss {

    public sexyyy() throws Exception {
        super(BossID.sexy, BossesData.sexyyy);
    }
   @Override
    public void reward(Player plKill) {
        ...
        itemMap = Util.ratiItem(zone,1956, 1, this.location.x, this.location.y, plKill.id);
