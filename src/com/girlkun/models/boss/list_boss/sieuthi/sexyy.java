...
public class sexyy extends Boss {

    public sexyy() throws Exception {
        super(BossID.sexyy, BossesData.sexyy);
    }
   @Override
    public void reward(Player plKill) {
        ...
        itemMap = Util.ratiItem(zone,1955, 1, this.location.x, this.location.y, plKill.id);
